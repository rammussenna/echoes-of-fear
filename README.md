...
- **Loop-Based Narrative Design**  
  Each cycle reveals new details, changes environments, or alters interactions, simulating the descent into madness and memory distortion.
...
> “There’s a special kind of hell for people who never learn.”

- Cyclical trauma
- Repression and denial
- Memory decay
- Loss and guilt
- Personal hells and internal punishment
...
- **Morning** – A repeatable "safe" section.
- **Midday** – Interactions that seem normal at first, but subtly change.
...
- **Soundtrack** – Ambient horror, reversed samples, vinyl hiss, occasional silence.
- **Voice Acting** – Minimalist. Mostly echoes, distorted past conversations, inner voices.
- **SFX** – Glitches, slow fades, distorted memories; sound is used to disorient and disturb.
...
- **Developer / Writer / Director** – Scribbleandwrite
- **Voice Actors** – To be announced (community-based, likely same pool as *Sorbetes*)  
- **Audio Direction** – Dale Salvador  
- **Engine** – Unity
